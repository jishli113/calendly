        ...
        <div className="newtag-wrap">
            <div className="newtag-main">
                <Container className="position-relative" fluid>
                    <Row>
                        <Col>
                            <FontAwesomeIcon icon={faXmark} className="float-end my-1 me-1" onClick={props.handleClose}></FontAwesomeIcon>
                        </Col>
                    </Row>
                    <Row className="my-3 justify-content-md-center">
                        <Col lg="6">
                            <Form>
                                <Form.Control type="text" placeholder='Your Tag Name...' onChange={(e)=>setTagName(e.target.value)}>
                                </Form.Control>
                            </Form>
                        </Col>
                    </Row>
                    <Row className="my-3">
                        <Col lg="12">
                            {tagError && <p className="text-center" style={{color:"red"}}>Tag Name is Already Taken</p>}
                        </Col>
                    </Row>
                    <Row className="my-3 align-items-end">
                        <Col lg={{span:2,offset:2}}>
                            <SquareFill size={60} color={tagcolor} onClick={()=>setToggleSelectColor(!toggleSelectColor)} cursor="pointer"></SquareFill>
                        </Col>
                    ...
                    <Row>
                        <Col lg={{span:3, offset:2}}>
                            <TagColorPicker handleSelectColor={onSelectColor}></TagColorPicker>
                        </Col>
                    </Row>}
