...
const Events = () => {
  ...
  function handleCalendarChange(date) {
    let formatDate = `${date.getFullYear()}-${date.getMonth() + 1 < 10 && "0"}${
      date.getMonth() + 1
    ...
    <>
      ...
      <Container fluid className="nopadding">
        <Row className="nopadding">
          <Col lg={selectedTime === "daily" ? 9 : 12} className="nopadding">
            <Container
              fluid
              className={
                "events-body"
            ...
            >
              <Col lg={5}>
                <Row>
                  ...
                  <Col lg={{ span: 5, offset: 4 }} className="my-5">
                    <Button onClick={() => setIsPoppedUp(true)}>
                      Event <FontAwesomeIcon icon={faPlus}></FontAwesomeIcon>
                    </Button>
                  </Col>
                </Row>
              </Col>
              ...
              {selectedTime === "daily" ? (
                ...
                <div className="event-display">
                  <WeeklyView
                    className="weekly-view-display"
                    day={selectedDay.toString()}
                    end={pers.getItem("weekEnd")}
                  />
                </div>
              )}
            </Container>
