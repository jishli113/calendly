  ...
  return props.trigger ? (
    <div className="fol-popup">
      <div className="fol-popup-inner">
        ...
        ></FontAwesomeIcon>
        {props.folswitch ? (
          <h1 className="follower-or-following" key="Followers">
            Followers
          </h1>
        ) : (
          <h1 className="follower-or-following" key="Following">
            Following
          </h1>
        )}
        {!isLoading && (
            ...
            {ppllist.map((people) =>
              props.folswitch ? (
                <li className="friendtab-popup">
                  <FriendTab
                    username={people.key.followingusername}
                    pfpimg={people.key.pfpimg}
                  />
                </li>
              ) : (
                <li className="friendtab-popup">
                  <FriendTab
                    username={people.key.forusername}
                    pfpimg={people.key.pfpimg}
                  />
                </li>
              )
