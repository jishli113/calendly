...
const NewEventPopup = (props) => {
  ...
  const [username, setUsername] = useState(
    pers.getItem("contextUsername") === "undefined"
      ? contextUsername
  ...
  async function checkNext() {
    ...
    if (
      ...
      if (
        Temporal.PlainDate.compare(s, e) == 1 ||
          ...
          <div>
            <Form>
              <Container fluid>
                ...
                <Row>
                  {invalidDate && (
                    <Form.Label style={{ color: "red", textAlign: "center" }}>
                      Invalid Time Frame
                    </Form.Label>
                  )}
                  {recurringEventName && (
                ...
                <Row className="my-5">
                  <Col>
                    <Dropdown
                      ...
                      defaultValue="This Event Repeats..."
                    >
                      <Dropdown.Toggle>{repeats}</Dropdown.Toggle>
                      <Dropdown.Menu>
            ...
            {tagPopup && (
              <NewTagPopup handleClose={handleTagPopUp}></NewTagPopup>
            )}
          </div>
        ) : (
